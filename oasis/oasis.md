...
```mermaid
graph TD
    subgraph EngineMap ["ADVERSARIAL ENGINE MAP"]
        Red["<b>RED TEAM (HOSTILE)</b><br/>Domain Specialists"]
        Blue["<b>BLUE TEAM (DEFENDER)</b><br/>O.N.E. Constitution"]
        Purple["<b>PURPLE TEAM (PATCH COMPILER)</b><br/>• Zero-Day Vulnerability ID<br/>• Invariant Verification<br/>• Constitutional Patching"]
        Audit["<b>PUBLIC AUDIT LOG & RAG BASE</b><br/>(Epistemic Oracle Ingest)"]
...
```mermaid
graph TD
    User["USER INQUIRY"] --> Parser["<b>SEMANTIC INTENT PARSER</b>"]

    Parser --> Canon["<b>CANONICAL CORPUS</b><br/>• Constitution<br/>• Chapters I - X"]
    Parser --> Logs["<b>ADVERSARIAL LOGS</b><br/>• Red-Team Attacks<br/>• Purple Patches"]

    Canon --> Engine["<b>SYNTHESIS & RESPONSE ENGINE</b><br/>• Invariant Foundation<br/>• Real-World Mechanism<br/>• Proven Failure Prevention"]
    Logs --> Engine
```
