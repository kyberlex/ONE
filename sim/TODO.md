...
- [ ] **Dual-Track Telemetry Bridge Integration:** Connect live Shelly / MQTT webhooks to provide in-game node stability bonuses.
- [ ] **Dynamic Climate Disaster Events:** Atmospheric rivers and heat dome stress-tests on crop resilience.
- [ ] **Inter-Node Trade Convoys:** Multi-hex barter logistics with neighboring autonomous nodes.
