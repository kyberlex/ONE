...
export const it = {
  ...
  // --- Scheda Cittadino (panel_citizen.js) ---
  'citizen.status_player': 'Tu (Giocatore Locale)',
  'citizen.status_peer': 'Pioniere in Rete (Online)',
  'citizen.status_child': 'Giovane Pioniere (Allievo)',
  'citizen.status_elder': 'Saggio della Comunità & Mentore',
  'citizen.status_resident': 'Residente della Comunità',
  'citizen.character_studio': 'STUDIO DEL PERSONAGGIO',
  'citizen.rotate_toggle_tooltip': 'Attiva/disattiva rotazione',
  'citizen.rotate_btn': '🔄 Rotazione',
  'citizen.reset_cam_tooltip': 'Reimposta visuale',
  'citizen.reset_cam_btn': '🔍 Reimposta',
  'citizen.drag_hint': 'Trascina per ruotare • Zoom con rotella o dita',

  // --- Passaporto Sovrano & Studio (panel_passport.js) ---
  'passport.outfit_tunic': 'Tunica Solarpunk',
  'passport.outfit_overalls': 'Tuta da Lavoro',
  'passport.hair_short': 'Corti Classici',
  'passport.hair_ponytail': 'Coda di Cavallo',
  'passport.hair_long': 'Lunghi Fluenti',
  'passport.hair_bob': 'Caschetto',
  'passport.hair_bun': 'Chignon Alto',
  'passport.hair_pigtails': 'Doppio Chignon',
  'passport.hair_messy': 'Mossi Spettinati',
  'passport.hair_fade': 'Sfumati Moderni',
  'passport.hair_beard': 'Barba Solarpunk',
  'passport.studio_badge': 'STUDIO PIONIERE',
  'passport.studio_rotate_hint': '🖱️ Ruota 360° • Zoom',
  'passport.outfit_silhouette': 'Abito & Silhouette:',
  'passport.hairstyle': 'Acconciatura:',
  'passport.hair_color': 'Colore Capelli:',
  'passport.skin_tone': 'Tonalità Carnagione:',
  'passport.wizard_title': 'Benvenuto in O.N.E. • Rilascio Passaporto del Cittadino',
  'passport.wizard_subtitle': 'Nessun account centrale, nessuna password o server esterno. I tuoi dati restano al 100% sul tuo dispositivo.',
  'passport.prompt_name': 'Qual è il tuo nome / soprannome da pioniere?',
  'passport.placeholder_name': 'es. Maya, Elena, Sol_Builder, Marco...',
  'passport.hint_name': 'Unico e salvato localmente, senza registrazione o e-mail esterne.',
  'passport.appearance_label': 'Aspetto del Tuo Pioniere (Studio Personaggio):',
  'passport.vocation_label': 'Scegli la tua vocazione o mestiere iniziale:',
  'passport.polytech_title': 'Accademia Civica & Apprendimento Continuo',
  'passport.polytech_sub': 'Evoluzione delle Competenze',
  'passport.polytech_desc': 'La vocazione iniziale <strong>non è vincolante né definitiva</strong>. In O.N.E. puoi cambiare mestiere, apprendere nuove abilità e formarti quando vuoi presso l\'<strong>Accademia Politecnica</strong> della comunità.',
  'passport.btn_create_identity': 'Crea Identità & Emetti Passaporto',
  'passport.btn_has_passport': 'Ho già un passaporto (Importa token da altro dispositivo)',
  'passport.generating_identity': 'Creazione Identità & Chiavi Locali…',
  'passport.label_citizen_id': 'ID PASSAPORTO CITTADINO',
  'passport.label_device_key': 'CHIAVE UNICA DISPOSITIVO',
  'passport.label_issue_date': 'DATA DI EMISSIONE',
  'passport.label_usufruct_pod': 'ALLOGGIO IN USUFRUTTO',
  'passport.val_dwelling_default': 'Dimora #1 • Detroit Commons',
  'passport.label_token_box': 'Codice Personale del Cittadino (Ripristinabile senza server):',
  'passport.copy_clipboard_tooltip': 'Copia negli appunti',
  'passport.btn_copy': 'Copia',
  'passport.p2p_sync_title': '📲 Sincronizzazione Dispositivi con QR Code',
  'passport.qr_scan_prompt': 'Inquadra con la fotocamera del telefono o tablet:',
  'passport.qr_scan_desc': 'Associazione diretta e immediata: clona il profilo senza digitare codici.',
  'passport.storage_security_title': 'Archiviazione Locale & Sicurezza',
  'passport.label_storage': 'Memoria Locale:',
  'passport.label_security': 'Sicurezza:',
  'passport.val_security': 'Crittografia Locale del Dispositivo',
  'passport.label_actions': 'Azioni Registrate:',
  'passport.actions_recorded': 'azioni registrate',
  'passport.label_direct_connection': 'Connessione Diretta Rete:',
  'passport.status_active': 'Attiva',
  'passport.connections': 'connessioni',
  'passport.status_ready': 'Pronta (Rete Locale / Wi-Fi)',
  'passport.recent_actions': 'Ultime azioni registrate:',
  'passport.direct_channel': '📡 Canale Diretto Senza Server',
  'passport.btn_create_ticket': 'Crea Invito',
  'passport.placeholder_ticket': 'Incolla invito ONE_OFFER: o ONE_ANSWER:...',
  'passport.btn_connect': 'Connetti',
  'passport.btn_test_signature': 'Prova Firma Digitale',
  'passport.btn_sync_now': 'Sincronizza Ora',
  'passport.btn_switch_pioneer': 'Cambia Pioniere',
  'passport.tooltip_oblivion': 'Diritto all\'Oblio',
  'passport.btn_burn_identity': 'Elimina Dati & Riparti da Zero (Diritto all\'Oblio)',
  'passport.burn_hint': 'Distrugge in modo sicuro e definitivo le chiavi locali da questo dispositivo e restituisce la dimora al bene comune.',

  // --- Chat Demarchica & Frasi Rapide (chat_engine.js) ---
  'chat.cat_demarchy': '🏛️ Consiglio & Assemblea',
  'chat.cat_demarchy_short': 'Consiglio',
  'chat.phrase_council_caucus_label': 'Richiesta Parere Consiglio',
  'chat.phrase_council_caucus_text': '🏛️ In qualità di membro nel Consiglio dei Cittadini, chiedo il parere di tutti sul dilemma attivo!',
  'chat.phrase_uphold_usufruct_label': 'Difesa Invariante Usufrutto',
  'chat.phrase_uphold_usufruct_text': '📜 Promemoria: gli alloggi non occupati tornano al bene comune civico. Zero speculazione.',
  'chat.phrase_call_mediation_label': 'Mediazione Civica Locale',
  'chat.phrase_call_mediation_text': '⚖️ Attrito rilevato nella comunità. Chiedo la verifica al Pannello di Mediazione Civica.',
  'chat.phrase_celebrate_rotation_label': 'Turnazione nel Consiglio',
  'chat.phrase_celebrate_rotation_text': '🌿 Grazie ai concittadini uscenti per il loro turno civico. Diamo il benvenuto ai nuovi estratti!',

  // --- Interni Insediamento (interior_renderer.js) ---
  'interior.agora_civic_assembly': '🏛️ Agorà Centrale & Assemblea Civica',
  'interior.podium_name': '🎙️ Rostro dell\'Assemblea dei Cittadini',
  'interior.podium_desc': 'Podio aperto dove qualsiasi cittadino o ospite può presentare proposte alla comunità.',
  'interior.sortition_urn_name': '🏺 Urna per il Sorteggio Civico',
  'interior.sortition_urn_desc': 'Dispositivo meccanico per l\'estrazione casuale e trasparente dei cittadini nel consiglio.',

  // --- Insediamento Mondo & Canvas (settlement_renderer.js) ---
  'settlement.agora_name': 'Agorà Centrale & Assemblea Civica',
  'settlement.agora_desc': 'Padiglione dell\'assemblea democratica dove i cittadini si riuniscono per deliberare.',
  'settlement.activity_assembly': 'Partecipazione all\'Assemblea Civica',
  'settlement.agora_tag': '🏛️ Agorà & Assemblea Civica',
  'settlement.robot_unit': 'Unità Cibernetica Autonoma',
  'settlement.domain': 'Dominio',
  'settlement.task': 'Compito',
  'settlement.human_labor_cancelled': 'Lavoro Umano Cancellato',
  'settlement.hours_per_day': 'h/giorno',
  'settlement.robot_hint': 'Fabbricato nel FabLab con hardware aperto e automazione Edge SCADA. Zero debito, zero lavoro forzato.',
  'settlement.player_title': '👑 Tu (Pioniere Locale) — Giocatore O.N.E.',
  'settlement.vocation': 'Vocazione',
  'settlement.labor_multiplier': 'moltiplicatore lavoro',
  'settlement.primary_dwelling_active': 'Alloggio Primario in Usufrutto',
  'settlement.sabbatical_lock_active': 'Blocco Sabbatico Attivo',
  'settlement.no_dwelling_claimed': 'Nessun alloggio reclamato (Clicca su qualsiasi alloggio libero per reclamarlo in usufrutto!)',
  'settlement.connected_pioneer': 'Pioniere Connesso (In Rete)',
  'settlement.active_participant': 'Partecipante attivo della comunità',
  'settlement.mesh_verified': '⚡ Connessione locale attiva e verificata. Contribuisce in tempo reale.',
  'settlement.young_pioneer': 'Giovane Pioniere',
  'settlement.age': 'Età',
  'settlement.forest_school': 'Scuola del Bosco & Educazione Comunitaria • 0h di Obbligo di Lavoro',
  'settlement.child_care_guaranteed': 'Assistenza incondizionata al 100% garantita dalla Costituzione di O.N.E. (Art. 5.3 & 5.4).',
  'settlement.elder_title': 'Custode della Saggezza & Mentore',
  'settlement.elder_subtitle': 'Spazio Intergenerazionale & Focolare',
  'settlement.elder_detail': 'Esonero da turni gravosi; guida e forma gli apprendisti (+20% rendimento collettivo).',
  'settlement.community_resident': 'Residente della Comunità',
  'settlement.civic_rotation': 'Turnazione Civica',
  'settlement.resident_detail': 'Cittadino attivo nel mantenimento dei flussi termodinamici di base.',
  'settlement.your_dwelling': 'La Tua Dimora in Usufrutto',
  'settlement.dwelling_num': 'Alloggio',
  'settlement.occupant': 'Occupante',
  'settlement.night_rest': 'Riposo notturno nell\'alloggio (Ciclo Notte)',
  'settlement.shift': 'Turno',
  'settlement.labor_credit': 'credito lavoro',
  'settlement.vacant_dwelling_title': 'ALLOGGIO CIVICO LIBERO — Clicca per Reclamarlo in Usufrutto',
  'settlement.vacant_dwelling_detail': 'Alloggio gratuito garantito per nascita e partecipazione dalla Costituzione.',
  'settlement.infra_operational': 'Struttura comune operativa.',
  'settlement.infra_hint': 'Clicca per esaminare automazioni e flussi termodinamici.'
};
